  ...
  return (
    <div className="flex w-full items-center gap-[11px] py-4">
      ...
      <Select value={searchParams.get('rumah_ibadah') || 'all'} onValueChange={(v) => handleSelectChange('rumah_ibadah', v)}>
        <SelectTrigger className="flex h-[38px] w-auto min-w-[160px] items-center gap-2.5 rounded-full border border-[#DDD] bg-white px-4 py-1.5 shadow-[0_14px_37.8px_0_rgba(54,53,53,0.10)] focus:ring-0 focus:ring-offset-0">
      ...
      <Popover open={isCityPopoverOpen} onOpenChange={setIsCityPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className="flex h-[38px] w-auto min-w-[120px] items-center justify-between gap-2.5 rounded-full border border-[#DDD] bg-white px-4 py-1.5 font-normal text-brand-text shadow-[0_14px_37.8px_0_rgba(54,53,53,0.10)] hover:bg-white focus:ring-0 focus:ring-offset-0"
          >
      ...
      <Select value={searchParams.get('status') || 'all'} onValueChange={(v) => handleSelectChange('status', v)}>
        <SelectTrigger className="flex h-[38px] w-auto min-w-[120px] items-center gap-2.5 rounded-full border border-[#DDD] bg-white px-4 py-1.5 shadow-[0_14px_37.8px_0_rgba(54,53,53,0.10)] focus:ring-0 focus:ring-offset-0">
      ...
      <div className="relative flex-1">
        <Input
          ...
          className="h-[44px] w-full rounded-full border border-[#DDD] bg-white pl-5 pr-12 shadow-[0_14px_37.8px_0_rgba(54,53,53,0.10)] focus-visible:ring-0 focus-visible:ring-offset-0"
        />
