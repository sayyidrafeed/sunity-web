      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 flex justify-center">
          <p className="font-jakarta text-2xl font-medium text-brand-green">
            <span className="font-outfit text-4xl font-bold">1.000+</span>{' '}
            Kampanye Telah Dipublikasikan
          </p>
        </div>
        ...
        <div className="mx-auto mt-8 grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {campaignReviews.map((campaign) => (
            <article
              key={campaign.id}
              className="rounded-[18px] bg-brand-green p-3 shadow-[0_20px_30px_rgba(47,107,63,0.24)]"
            >
              <img
                src={campaign.image}
                alt={campaign.title}
                className="h-[135px] w-full rounded-[12px] object-cover"
              />

              <div className="mt-4 flex items-start justify-between gap-3">
                <h3 className="max-w-[140px] font-outfit text-lg font-bold leading-tight text-white">
                  {campaign.title}
                </h3>

                <p className="mt-1 flex items-center gap-1 font-jakarta text-[11px] text-white">
                  <img
                    src="/images/icon-location-2.png"
                    alt=""
                    aria-hidden="true"
              ...
              <div className="mt-5 flex justify-end">
                ...
                >
                  <img
                    src="/images/icon-arrow-yellow-white.png"
                    alt=""
                    aria-hidden="true"
        ...
        <div className="mt-10 flex justify-center">
          ...
          >
            Lihat Semua
            <img
              src="/images/icon-arrow-green-white.png"
              alt=""
              aria-hidden="true"
              className="h-4 w-4 object-contain"
            />
