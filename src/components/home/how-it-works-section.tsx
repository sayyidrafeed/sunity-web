...
export function HowItWorksSection() {
  return (
    <section
      id="cara-kerja"
      className="relative overflow-hidden bg-[#2F6F44] px-6 py-24"
    >
            ...
            {steps.map((step) => (
              <div key={step.title} className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-md font-['Plus Jakarta Sans'] text-base leading-relaxed text-white/90">
                    {step.description}
                  </p>
                </div>
              </div>
        ...
        <div className="relative z-10 flex justify-center">
          <div className="relative h-[520px] w-[520px]">
            ...
            <div className="absolute left-6 top-28 flex items-center gap-2 rounded-lg bg-[#FAF9F6]/80 px-4 py-2 shadow-lg backdrop-blur-md">
              <img
                src="/images/icon-sunity-badge.png"
                alt="Sunity"
                className="h-7 w-7 object-contain"
              />
              <div>
                <p className="font-['Outfit'] text-sm font-bold leading-none text-[#2F6F44]">
                  Sunity
                </p>
                <p className="mt-1 font-['Plus Jakarta Sans'] text-[10px] font-semibold leading-none text-[#2F6F44]/80">
            ...
            <div className="absolute right-0 top-44 flex items-center gap-2 rounded-lg bg-[#FAF9F6]/80 px-4 py-2 shadow-lg backdrop-blur-md">
              <img
                ...
                className="h-7 w-7 object-contain"
              />
              <p className="font-['Plus Jakarta Sans'] text-sm font-semibold text-[#2F6F44]">
                Aman dan Terpercaya
              </p>
            </div>
